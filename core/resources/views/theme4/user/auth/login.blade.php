        ...
        <div class="auth-wrapper">
            <div class="auth-top-part">
             <!--   <a href="{{ route('home') }}" class="auth-logo">
                ...
                <p class="mb-0"><span class="me-2">{{ __('Haven\'t an Account?') }}</span> <a class="btn gr-bg-8 text-white btn-sm" href="{{ route('user.register') }}">{{ __('Register') }}</a></p>
            </div>
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="" method="POST">
                        ...
                        @endif
                        <button class="btn gr-bg-9 text-white w-50 mt-3" type="submit"> <span>{{ __('Log In') }} </span></button>
                    </form>
                </div>
            </div>
