  ...
  <ul class="mobile-bottom-menu">
    <li>
      <a href="<?php echo e(route('user.deposit')); ?>" class="<?php echo e(activeMenu(route('user.deposit'))); ?>">
        ...
        <span><?php echo e(__('Trading')); ?></span>
      </a>
    </li>
    <li>
...
<!-- mobile bottom menu end --><?php /**PATH /home/u272239730/domains/bitcoingoldtrading.com/public_html/trade/core/resources/views/theme4/layout/user_sidebar.blade.php ENDPATH**/ ?>